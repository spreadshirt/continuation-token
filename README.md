...
A detailed explanation of the approach and the used algorithm can be found in the blog post ["Web API Pagination with Continuation Tokens"](TODO). Some bullet points about continuation tokens are:
